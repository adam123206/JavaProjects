 ...
 */
  public void write(){
    try{
        ...
        //普通字符
        Label labelCFC = new Label(1, 1, "riverwindlkjhgf"); 
 ...
 */
  public static void main(String[] arges){
    try{
      ...
      //生成一个可读取的excel文件对象
      me.workbook = Workbook.getWorkbook(new File("E:\\fbackup\\代码目录\\Workspace_adam\\JAVA_SE\\bin\\com\\instances\\io\\myfile.xls"));
      //使用第一个工作表
