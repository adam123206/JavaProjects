 ...
 */
  public void write(){
   try{
     ...
     PdfWriter.getInstance(document, new FileOutputStream("E:\\fbackup\\代码目录\\Workspace_adam\\JAVA_SE\\src\\com\\instances\\io\\table.pdf"));
     //创建汉字字体
     BaseFont bfSong = BaseFont.createFont("STSong-Light", "UniGB-UCS2-H", false);
     Font fontSong = new Font(bfSong, 10, Font.NORMAL);
     // 增加一个水印
     try {
         Watermark watermark = new Watermark(Image.getInstance("E:\\fbackup\\代码目录\\Workspace_adam\\JAVA_SE\\src\\com\\instances\\io\\test.jpg"), pageRect.left()+50,pageRect.top()-85);
